...
export default class Victoire2 extends Phaser.Scene {
  // constructeur de la classe
  constructor() {
    super({
      key: "Victoire2" //  ici on précise le nom de la classe en tant qu'identifiant
    });
  }
  preload() {
    this.load.image("img_victoire", "src/assets/victoire.jpg")
    this.load.image("imageBoutonPlay", "src/assets/images_btn.png")
    this.load.audio("victoire_mario","src/assets/victoiremario.mp3")
  }
  ...
  create() {
   ...
   sonvictoire2 = this.sound.add("victoire_mario");
   sonvictoire2.play()
